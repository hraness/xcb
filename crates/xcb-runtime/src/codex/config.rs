...
pub const BINARY_SHA256: &str = "0196e89fe5a7598f816ee54232c3d7c26d75e502ab5cfe2c9240e81d90f7255a";
/// Sorted relative schema path, NUL, generated bytes, NUL for each JSON file
/// written by `codex app-server generate-json-schema --experimental`.
pub const SCHEMA_SHA256: &str = "0f15f18e41d59367b3655adac23fe1525be483dc38f6fd56d07fc627eb802129";
...
mod tests {
    ...
    fn untested_builds_and_forged_catalogs_are_not_admitted() {
        ...
        assert!(!version_admitted("0.155.0-alpha.2.6"));
