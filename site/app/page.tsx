...
const questions = [
  ...
  { question: "Can I use it for daily work today?", answer: "The tested Claude and Codex setups passed real coding workflows on macOS ARM64. Native xcb is still a source preview: provider builds are restricted and command execution uses offline Linux. Devin's credential-free boundary checks are separate from authenticated coding acceptance; account model availability is checked at launch. Read the setup guide to decide whether those boundaries fit your projects." },
        ...
        <MarketingPage>
          ...
          <MarketingSection id="readiness" heading="Useful today. Clear about the edges." headingId="readiness-title" summary="Native xcb is a source preview. The current evidence covers specific builds and tested accounts, not every provider or machine.">
            <div className="xcb-readiness">
              ...
              <div><span className="xcb-status-dot xcb-status-caution" aria-hidden="true" /><h3>Devin</h3><p>Exact-build credential-free boundary checks passed. Account model availability is checked at launch; coding acceptance requires authenticated run evidence.</p><a href="/docs/providers#devin">Current Devin boundary ↗</a></div>
