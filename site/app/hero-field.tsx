...
const notes: FieldNote[] = [
  { id: "devin", type: "agent", title: "devin", body: "Supported build on macOS. Ranked below the pick.", x: 13, y: 26, rotate: 1.4, width: 178, drift: [10, 14], seconds: 38, delay: -21 },
  { id: "codex", type: "agent", title: "codex · plus", body: "Signed in and idle. gpt-5.2-codex seen moments ago.", tags: ["eligible"], x: 46, y: 11, rotate: -1.2, width: 186, drift: [11, 10], seconds: 45, delay: -14 },
  { id: "claude", type: "agent", title: "claude · max", body: "Signed in. Inside a provider-reported quota window.", tags: ["resumes at reset"], x: 79, y: 13, rotate: 1.7, width: 172, drift: [13, 9], seconds: 44, delay: -30 },
  { id: "task", type: "task", title: "fix the failing parser test", body: "Arrives as a task. Carries no credentials or hooks.", x: 9, y: 55, rotate: -1.6, width: 180, drift: [9, 12], seconds: 41, delay: -8 },
  { id: "route", type: "route", title: "route → codex/gpt-5.2-codex", body: "One turn on one model. The returned text is capped.", x: 34, y: 39, rotate: -0.8, width: 198, drift: [10, 12], seconds: 40, delay: -5, bloom: true },
  { id: "session", type: "session", title: "session s_4f2a", body: "Resumable. Processes exited; outcome recorded.", x: 60, y: 50, rotate: 0.9, width: 188, drift: [8, 13], seconds: 47, delay: -18 },
  { id: "lease", type: "lock", title: "account held · a7f2", body: "One task at a time. Released after the provider process exits.", x: 86, y: 62, rotate: -1.1, width: 192, drift: [14, 8], seconds: 39, delay: -2 },
  { id: "quota", type: "limit", title: "quota window", body: "The account sits out until the provider’s reported reset.", x: 90, y: 36, rotate: 0.6, width: 176, drift: [8, 11], seconds: 48, delay: -26 },
  { id: "terminal", type: "terminal", title: "$ xcb --json route", body: "stdin: one JSON task\nstdout: one JSON result", x: 20, y: 79, rotate: -2, width: 204, drift: [12, 9], seconds: 35, delay: -15 },
  { id: "receipt", type: "record", title: "record verified", body: "Replays the task’s local record to check it.", x: 49, y: 85, rotate: 1.5, width: 182, drift: [9, 11], seconds: 44, delay: -27 },
  { id: "manifest", type: "rule", title: "routing rule", body: "In development. Kept only if it scores strictly better.", x: 74, y: 86, rotate: -2.2, width: 176, drift: [8, 14], seconds: 40, delay: -11 },
];
