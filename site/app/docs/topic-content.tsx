...
xcb reflex status settle   # generation, live precision and recall, open trials`}</Code>
      ...
      <ul>
        <li>Reply <code>continue</code>, <code>keep going</code>, or <code>push it</code> right after a task completes, and xcb records that the turn stopped short. With settle active, it also reopens that task in its session.</li>
