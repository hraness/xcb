...
xcb plugins`}</Code>
      ...
      <p>The v0.7 editor uses familiar Codex CLI keys: <code>Ctrl-R</code> searches prompt history, <code>Ctrl-T</code> opens saved messages, <code>F3</code> searches the transcript, and <code>Ctrl-G</code> opens your editor. <code>/drafts</code> recovers private input without sending it. See the <a href="https://github.com/hraness/xcb/blob/main/docs/terminal.md" target="_blank" rel="noopener noreferrer">terminal guide ↗</a> for shortcuts, agent controls, and recovery limits.</p>
